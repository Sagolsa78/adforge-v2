...
## 1. Why Delayed Auth?
AdForge v2 optimizes for maximum user acquisition by minimizing initial friction. Users can input their website and watch our AI execute a deep analysis completely for free, without needing to sign up. 
...
* Immediately upon any error encountered *during* the claim flow to ensure graceful UI failure preventing infinite loops.
